...
(
    ...
    'VIP customer with excellent loyalty', true, 'system',
...
(
    ...
    'Regular customer with good payment history', true, 'system',
...
(
    ...
    'New customer with limited history', true, 'system',
...
(
    ...
    'Inactive customer - no recent orders', false, 'system',
...
(1, 1, CURRENT_TIMESTAMP), -- Acme Corp to VIP Customers
